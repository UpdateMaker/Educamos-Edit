...
input.setAttribute("style", "background-color: #0072c6;padding: 4px 22px;font-size:13px;color: white;border:0px;font-size:14px;position:absolute;top:235px;right:60px;");
input.onclick = loco;
